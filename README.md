...
| ------------------ | ------------------------ | ------------------------------------------------------------------ |
| `@useupup/react`   | `npm i @useupup/react`   | [React quickstart](https://useupup.com/docs/quickstarts/react)     |
| `@useupup/vue`     | `npm i @useupup/vue`     | [Vue quickstart](https://useupup.com/docs/quickstarts/vue)         |
| `@useupup/svelte`  | `npm i @useupup/svelte`  | [Svelte quickstart](https://useupup.com/docs/quickstarts/svelte)   |
| `@useupup/angular` | `npm i @useupup/angular` | [Angular quickstart](https://useupup.com/docs/quickstarts/angular) |
| `@useupup/vanilla` | `npm i @useupup/vanilla` | [Vanilla quickstart](https://useupup.com/docs/quickstarts/vanilla) |
