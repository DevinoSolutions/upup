...
- **`https://useupup.com/llms.txt`** — a concise index of upup, its packages, and
  the key docs pages.
- **`https://useupup.com/documentation/llms-full.txt`** — the fuller context dump
...
Quickstarts: https://useupup.com/documentation/quickstarts/<react|vue|svelte|angular|vanilla|preact|next>
```
...
- Framework quickstarts: [React](./quickstarts/react.md), [Vue](./quickstarts/vue.md),
  [Svelte](./quickstarts/svelte.md), [Angular](./quickstarts/angular.md),
  [Vanilla JS](./quickstarts/vanilla.md), [Preact](./quickstarts/preact.md),
  [Next.js](./quickstarts/next.md).
- [Server Mode — Setup](./guides/server-mode-setup.md) for the full server walkthrough.
