...
| Headless core           | React hooks (coupled to the service)                                                                                                                           | Yes (`@upup/core`, framework-agnostic)                                                           |
...
| Storage / self-host     | Managed — files are stored on UploadThing's infrastructure                                                                                                     | Any S3-compatible storage you own (AWS, MinIO, R2, Spaces, Wasabi, Backblaze) via `@upup/server` |
