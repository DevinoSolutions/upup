...
through the [`onError` seam](./error-monitoring.md) with the route, method,
...
See [Client Mode vs Server Mode](./modes.md) for when to reach for Server Mode,
[Server Mode — Setup](./server-mode-setup.md) for wiring the handler into
Next.js, Express, Fastify, or Hono, and [Storage Providers](./storage-providers.md)
