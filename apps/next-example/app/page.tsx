...
// from @upup/next and rendering it proves the 'use client' directive survived the
...
export default function Home() {
  return (
    <main style={{ maxWidth: 720, margin: '40px auto', padding: 16 }}>
      <h1>@upup/next — App Router</h1>
      <p>
        Server-mode uploader talking to the App Router handler at <code>/api/upup</code>.
      </p>
