...
export default function PlaygroundHeader() {
    ...
    // /mobile-demo is a chrome-free embed harness that themes itself from its
    // `darkMode` query param, so this toggle cannot reach it and its label
    // misreports the state there. That route already hid this header two other
    // ways (a `display:none !important` style block and an inline-style effect);
    // not rendering it is the source-level version of both.
