...
const serverSchema = z.object({
    ...
    UPUP_UPLOAD_TOKEN_SECRET: z
        .string()
        .min(1)
        .default('playground-dev-secret-not-for-prod'),
...
const clientSchema = z.object({
    ...
    NEXT_PUBLIC_UPUP_UPLOAD_ENDPOINT: z.string().optional(),
    NEXT_PUBLIC_UPUP_USE_REAL_STORAGE: z.string().optional(),
...
const clientParsed = clientSchema.safeParse({
    ...
    NEXT_PUBLIC_UPUP_UPLOAD_ENDPOINT:
        process.env.NEXT_PUBLIC_UPUP_UPLOAD_ENDPOINT,
    NEXT_PUBLIC_UPUP_USE_REAL_STORAGE:
        process.env.NEXT_PUBLIC_UPUP_USE_REAL_STORAGE,
