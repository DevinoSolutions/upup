...
| -------------------------------------------------------------- | ------------------------ | ------------------------ |
| [Express](/docs/guides/server-adapters/express/)               | `createUpupMiddleware`   | `@useupup/server/express` |
| [Fastify](/docs/guides/server-adapters/fastify/)               | `createUpupPlugin`       | `@useupup/server/fastify` |
| [Hono](/docs/guides/server-adapters/hono/)                     | `createUpupRoutes`       | `@useupup/server/hono`    |
| [Next.js — App Router](/docs/guides/server-adapters/nextjs/)   | `createUpupNextHandler`  | `@useupup/next/server`    |
| [Next.js — Pages Router](/docs/guides/server-adapters/nextjs/) | `createUpupPagesHandler` | `@useupup/next/server`    |
