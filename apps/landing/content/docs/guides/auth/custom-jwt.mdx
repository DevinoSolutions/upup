...
description: Verify your own JWT inside @useupup/server's getUserId hook with jose — bearer or cookie, shared secrets, and remote JWKS for asymmetric tokens.
---
