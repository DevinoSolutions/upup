...
description: Wire a Better Auth session into @useupup/server so every upload is scoped to the signed-in user — the getUserId hook, gated sessions, uid binding.
---
