...
description: Install upup and run your first upload — local file selection, client uploads straight to your storage, or full server mode with @useupup/server.
---
