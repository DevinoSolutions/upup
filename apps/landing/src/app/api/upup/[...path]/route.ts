...
// Fail fast (by name) if the HMAC upload-token secret is missing. The rest of
// the landing site still renders; only this upload route refuses to boot on an
// absent/public secret (which would defeat the server trust model).
