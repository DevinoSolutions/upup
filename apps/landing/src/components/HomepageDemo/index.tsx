...
export default function HomepageDemo() {
  ...
  }, [mini, selectedTheme, enabledAdapters, allowPreview, shouldCompress, restrictionsEnabled, limit, fileSizeValue, fileSizeUnit, isDarkMode, mobileMode, autoRetryEnabled, autoRetryCount]);
