...
/**
 * ssr.spec.tsx — SSR regression tests for @upupjs/preact
 *
 ...
 * is safe to render on the server. Does NOT re-test @upupjs/react logic (659
 * tests cover that).
 *
...
describe('@upupjs/preact SSR (preact-render-to-string, no window/document)', () => {
