...
export const uploaderArgTypes: Record<string, unknown> = {
    ...
    provider: {
        control: 'text',
        description: 'Storage provider id (e.g. "aws").',
        ...cat('Upload'),
    },
    mode: {
        control: { type: 'select' },
    ...
    cloudDrives: {
        control: false,
        description: 'OAuth configs from VITE_* env vars; see cloudDrives.ts.',
        ...cat('Sources'),
    },
    ...
    allowedFileTypes: {
        control: 'text',
        description: 'MIME patterns, extensions, or preset names.',
        ...cat('Limits'),
    },
    ...
    webWorker: {
        control: 'boolean',
        description:
            'Offload the file pipeline (hash/heic/exif/thumbnail/compress) to a Web Worker. Unset/true = auto with transparent main-thread fallback; false = force the main thread.',
        ...cat('Processing'),
    },
    ...
    themeMode: {
        ...
        description: 'Virtual — mapped to theme.mode in render.',
        ...cat('Appearance'),
    },
    primaryColor: {
        control: 'color',
        description:
            'Virtual — mapped to theme.tokens.color.primary in render.',
        ...cat('Appearance'),
    },
