...
describe('FileSource', () => {
    ...
    it('defines MICROPHONE', () =>
        expect(FileSource.MICROPHONE).toBe('microphone'))
...
describe('StorageProvider', () => {
    it('defines AWS with value "aws"', () =>
        expect(StorageProvider.AWS).toBe('aws'))
    it('defines Azure with value "azure"', () =>
        expect(StorageProvider.Azure).toBe('azure'))
    it('defines BackBlaze with value "backblaze"', () =>
        expect(StorageProvider.BackBlaze).toBe('backblaze'))
    it('defines DigitalOcean with value "digitalocean"', () =>
