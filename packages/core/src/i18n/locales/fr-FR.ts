...
export const frFR: LocaleBundle = {
    ...
    messages: {
        ...
        dropzone: {
            dragFilesOr:
                '{count, plural, one {Glissez votre fichier ou} other {Glissez vos fichiers ou}}',
            dragFilesHere:
            ...
            maxFileCount:
                "Jusqu'\u00E0 {limit, plural, one {# fichier} other {# fichiers}}",
            minFileCount:
                'Au moins {limit, plural, one {# fichier requis} other {# fichiers requis}}',
            totalFileSizeExceeded:
                'La taille totale des fichiers d\u00E9passe le maximum de {size} {unit}',
        ...
        fileList: {
            uploadFiles:
                'T\u00E9l\u00E9verser {count, plural, one {# fichier} other {# fichiers}}',
        ...
        driveBrowser: {
            ...
            addFiles:
                'Ajouter {count, plural, one {# fichier} other {# fichiers}}',
            logOut: 'D\u00E9connexion',
            search: 'Rechercher',
            authenticatePrompt:
        ...
        errors: {
            ...
            failedToGetUploadUrl:
                "\u00C9chec de la r\u00E9cup\u00E9ration de l'URL d'envoi",
            statusError:
                'Statut : {status} ({statusText}). D\u00E9tails : {details}',
            networkErrorDuringUpload:
                'Erreur r\u00E9seau pendant le t\u00E9l\u00E9versement - Statut : {status} ({statusText})',
            ...
            invalidUploadEndpoint:
                'URL uploadEndpoint invalide : {uploadEndpoint} {error}',
            maxFileSizeMustBeGreater:
                'maxFileSize doit \u00EAtre sup\u00E9rieur \u00E0 0',
            invalidAcceptFormat:
                'Format accept invalide : {accept}. Utilisez des types MIME, */*, * ou des extensions (ex : .fbx)',
            unauthorizedAccess: 'Acc\u00E8s non autoris\u00E9 au fournisseur',
            presignedUrlInvalid:
                "L'URL pr\u00E9sign\u00E9e a expir\u00E9 ou est invalide",
            temporaryCredentialsInvalid:
                'Les identifiants temporaires ne sont plus valides',
            corsMisconfigured:
                'La configuration CORS emp\u00EAche le t\u00E9l\u00E9versement',
            ...
            failedToRefreshExpiredToken:
                '\u00C9chec du rafra\u00EEchissement du token expir\u00E9',
            allowedLimitSurpassed:
                'La limite autoris\u00E9e a \u00E9t\u00E9 d\u00E9pass\u00E9e !',
            ...
            minFileSizeAllowed:
                'Min {size} {unit} {count, plural, one {fichier requis} other {fichiers requis}}',
            minFileSizeMustBeGreater:
                'minFileSize doit \u00EAtre sup\u00E9rieur \u00E0 0',
            filePreviouslySelected:
                '{name} a d\u00E9j\u00E0 \u00E9t\u00E9 s\u00E9lectionn\u00E9',
            ...
            errorCompressingImage:
                "Erreur lors de la compression de l'image {name}",
            ...
            handleSignInFailed:
                '\u00C9chec du traitement de la connexion : {message}',
            signOutFailed: '\u00C9chec de la d\u00E9connexion : {message}',
            imageEditorFailed:
                "\u00C9chec du chargement de l'\u00E9diteur d'image...",
        },
    },
}
