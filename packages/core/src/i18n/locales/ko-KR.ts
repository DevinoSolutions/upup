    ...
    messages: {
        ...
        dropzone: {
            ...
            totalFileSizeExceeded:
                '총 파일 크기가 최대 {size} {unit}을(를) 초과합니다',
        ...
        errors: {
            ...
            invalidProvider:
                '잘못된 프로바이더: {provider}. 유효한 옵션: {validOptions}',
            invalidUploadEndpoint:
                '잘못된 uploadEndpoint URL: {uploadEndpoint} {error}',
            maxFileSizeMustBeGreater: 'maxFileSize는 0보다 커야 합니다',
            invalidAcceptFormat:
                '잘못된 accept 형식: {accept}. MIME 타입, */*, * 또는 확장자(예: .fbx)를 사용하세요',
            unauthorizedAccess: '프로바이더에 대한 미인증 액세스',
            presignedUrlInvalid:
                '사전 서명된 URL이 만료되었거나 유효하지 않습니다',
            temporaryCredentialsInvalid:
                '임시 자격 증명이 더 이상 유효하지 않습니다',
            ...
            graphClientNotInitialized:
                'Graph 클라이언트가 초기화되지 않았습니다',
            dropboxNoAccessToken:
                'Dropbox 다운로드용 액세스 토큰이 제공되지 않았습니다',
            ...
            silentTokenAcquisitionProceeding:
                '자동 토큰 획득 실패, 대화형 로그인으로 진행{details}',
