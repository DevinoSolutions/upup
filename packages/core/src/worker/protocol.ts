...
export type WorkerResult =
  ...
  | { kind: 'thumbnail'; thumbnailUrl: string; bytes: ArrayBuffer; type: string; name: string }
  | { kind: 'image'; bytes: ArrayBuffer; type: string; name?: string; metadata?: Record<string, unknown> }
