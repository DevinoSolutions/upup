...
// ── parametrized / simple icons (full ports) ──
export const UploadIcon = ({ size = 24, class: className = '' }: { size?: number; class?: string } = {}) => html`
...
export const XIcon = ({ size = 24 }: { size?: number } = {}) => html`
  <svg xmlns="http://www.w3.org/2000/svg" width=${size} height=${size} viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    <line x1="18" y1="6" x2="6" y2="18" />
    <line x1="6" y1="6" x2="18" y2="18" />
  </svg>`

export const LayoutGridIcon = ({ size = 24 }: { size?: number } = {}) => html`
  <svg xmlns="http://www.w3.org/2000/svg" width=${size} height=${size} viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    <rect x="4" y="4" width="6" height="6" rx="1" /><rect x="14" y="4" width="6" height="6" rx="1" />
    <rect x="4" y="14" width="6" height="6" rx="1" /><rect x="14" y="14" width="6" height="6" rx="1" />
  </svg>`

export const LayoutListIcon = ({ size = 24 }: { size?: number } = {}) => html`
  <svg xmlns="http://www.w3.org/2000/svg" width=${size} height=${size} viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    <rect x="4" y="4" width="16" height="6" rx="1" /><rect x="4" y="14" width="16" height="6" rx="1" />
  </svg>`

export const PlayerPlayFilledIcon = ({ size = 24 }: { size?: number } = {}) => html`
  <svg xmlns="http://www.w3.org/2000/svg" width=${size} height=${size} viewBox="0 0 24 24" fill="currentColor" stroke="none"><path d="M6 4l15 8-15 8z" /></svg>`

export const PlayerPauseFilledIcon = ({ size = 24 }: { size?: number } = {}) => html`
  <svg xmlns="http://www.w3.org/2000/svg" width=${size} height=${size} viewBox="0 0 24 24" fill="currentColor" stroke="none">
    <rect x="6" y="4" width="4" height="16" rx="1" /><rect x="14" y="4" width="4" height="16" rx="1" />
  </svg>`

export const LoaderIcon = ({ class: className = '' }: { class?: string } = {}) => html`
...
export const FileIconSvg = ({ class: className = '' }: { class?: string } = {}) => html`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class=${className}>
    <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><polyline points="14 2 14 8 20 8" />
  </svg>`

export const SearchIcon = ({ class: className = '' }: { class?: string } = {}) => html`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class=${className}>
    <circle cx="10" cy="10" r="7" /><line x1="21" y1="21" x2="15" y2="15" />
  </svg>`

export const UserIcon = ({ class: className = '' }: { class?: string } = {}) => html`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class=${className}>
    <path d="M12 7m-4 0a4 4 0 1 0 8 0a4 4 0 1 0 -8 0" /><path d="M6 21v-2a4 4 0 0 1 4 -4h4a4 4 0 0 1 4 4v2" />
  </svg>`

export const FolderIcon = ({ class: className = '' }: { class?: string } = {}) => html`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class=${className}>
    <path d="M5 4h4l3 3h7a2 2 0 0 1 2 2v8a2 2 0 0 1 -2 2h-14a2 2 0 0 1 -2 -2v-11a2 2 0 0 1 2 -2" />
  </svg>`

// ── brand/static icons (verbatim SVG from packages/svelte/src/components/icons/<Name>.svelte) ──

export const MyDeviceIcon = () => html`<svg aria-hidden="true" focusable="false" width="32" height="32" viewBox="0 0 32 32" class="upup-text-[#2275d7]">
...
export const GoogleDriveIcon = () => html`<svg aria-hidden="true" focusable="false" width="32" height="32" viewBox="0 0 32 32">
...
export const OneDriveIcon = () => html`<svg aria-hidden="true" focusable="false" width="32" height="32" viewBox="0 0 32 32">
...
export const DropBoxIcon = () => html`<svg class="upup-text-[#0061fe]" aria-hidden="true" focusable="false" width="32" height="32" viewBox="0 0 32 32">
...
export const BoxIcon = () => html`<svg class="upup-text-[#0061d5]" aria-hidden="true" focusable="false" width="32" height="32" viewBox="0 0 32 32">
...
export const LinkIcon = () => html`<svg aria-hidden="true" focusable="false" width="32" height="32" viewBox="0 0 32 32"><path d="M23.637 15.312l-2.474 2.464a3.582 3.582 0 01-.577.491c-.907.657-1.897.986-2.968.986a4.925 4.925 0 01-3.959-1.971c-.248-.329-.164-.902.165-1.149.33-.247.907-.164 1.155.164 1.072 1.478 3.133 1.724 4.618.656a.642.642 0 00.33-.328l2.473-2.463c1.238-1.313 1.238-3.366-.082-4.597a3.348 3.348 0 00-4.618 0l-1.402 1.395a.799.799 0 01-1.154 0 .79.79 0 010-1.15l1.402-1.394a4.843 4.843 0 016.843 0c2.062 1.805 2.144 5.007.248 6.896zm-8.081 5.664l-1.402 1.395a3.348 3.348 0 01-4.618 0c-1.319-1.23-1.319-3.365-.082-4.596l2.475-2.464.328-.328c.743-.492 1.567-.739 2.475-.657.906.165 1.648.574 2.143 1.314.248.329.825.411 1.155.165.33-.248.412-.822.165-1.15-.825-1.068-1.98-1.724-3.216-1.888-1.238-.247-2.556.082-3.628.902l-.495.493-2.474 2.464c-1.897 1.969-1.814 5.09.083 6.977.99.904 2.226 1.396 3.463 1.396s2.473-.492 3.463-1.395l1.402-1.396a.79.79 0 000-1.15c-.33-.328-.908-.41-1.237-.082z" fill="#FF753E" fill-rule="nonzero" /></svg>`

export const CameraIcon = () => html`<svg aria-hidden="true" focusable="false" width="32" height="32" viewBox="0 0 32 32">
...
export const AudioIcon = () => html`<svg class="upup-text-[#8030a3]" aria-hidden="true" focusable="false" width="32px" height="32px" viewBox="0 0 32 32">
...
export const ScreenCastIcon = () => html`<svg class="upup-text-[#2c3e50]" aria-hidden="true" focusable="false" width="32" height="32" viewBox="0 0 32 32">
