...
export function cameraUploader(ctx: RootContext) {
  ...
  const inner = html`
    <div data-testid="upup-camera-uploader" class="upup-flex upup-h-full upup-w-full upup-flex-col upup-justify-center upup-overflow-hidden upup-px-3 upup-py-2">
      <div class="upup-flex upup-min-h-0 upup-flex-1 upup-items-center upup-justify-center upup-pt-2">
        ${s.capturedUrl
          ? html`
              <div
                class=${cn('upup-relative upup-aspect-video upup-max-h-full upup-max-w-full upup-bg-black/[0.025] upup-bg-contain upup-bg-center upup-bg-no-repeat upup-shadow-xl', { 'upup-bg-white/5 dark:upup-bg-white/5': isDark }, slot.cameraPreviewContainer)}
          ...
          : html`
              <video
                ${ref(cam.videoRef)}
                autoplay muted playsinline class="upup-aspect-video upup-max-h-full upup-max-w-full upup-rounded-xl upup-object-contain"
              ></video>`}
      </div>
