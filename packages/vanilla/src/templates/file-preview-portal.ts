...
export function filePreviewPortal(
  ...
  const { fileType, fileUrl, fileName, fileSize, onClose, onStopPropagation } =
    args;
  ...
  const textState: TextState = (args.cell.textState ??= {
    content: "",
    loading: false,
    error: undefined,
    truncated: false,
  ...
  return html` <div class="upup-scope" data-upup-slot="file-preview-portal">
    <div
                  ...
                  ? html`
                      ...
                      >
                        ...
                        ${!textState.loading && !textState.error
                          ? html`
                              <pre class="upup-whitespace-pre-wrap">
${textState.content}</pre
                              ...
                              ${textState.truncated
                                ? html`
                                    ...
                                    >
                                      Content truncated - file is too large to
                                      preview in full.
                                    </div>
                                  `
                                : nothing}
