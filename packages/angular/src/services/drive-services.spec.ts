...
function setupService<
  T extends GoogleDriveService | OneDriveService | DropboxService | BoxService,
>(
...
describe("Drive service callback wiring", () => {
  ...
  it("GoogleDriveService: onFilesSelected fires store.handleSetSelectedFiles", () => {
    ...
    TestBed.configureTestingModule({
      providers: [{ provide: UpupStore, useValue: store }, GoogleDriveService],
    });
  ...
  it("DropboxService: onFilesSelected fires store.handleSetSelectedFiles", () => {
    const store = makeStoreMock();
    TestBed.configureTestingModule({
      providers: [{ provide: UpupStore, useValue: store }, DropboxService],
    });
