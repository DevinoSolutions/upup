...
export class AudioUploaderComponent implements OnDestroy {
    ...
    get outerRingClass(): string {
        return cn(
            'upup-flex upup-h-24 upup-w-24 upup-items-center upup-justify-center upup-rounded-full',
            {
                ...
                'upup-bg-blue-500/20': this.recordingState === 'idle' || this.recordingState === 'recorded',
            },
        )
    }
    ...
    get innerRingClass(): string {
        return cn(
            ...
            {
                'upup-animate-pulse upup-bg-red-500': this.recordingState === 'recording',
                'upup-bg-blue-500': this.recordingState === 'idle' || this.recordingState === 'recorded',
            },
        )
    }
