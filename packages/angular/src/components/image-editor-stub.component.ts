 ...
 *   <!-- Image editor is not supported in Svelte. Use @upupjs/react if image editing is required. -->
 */
@Component({
    selector: 'upup-image-editor-stub',
    standalone: true,
    template: `<!-- Image editor is not supported in Angular. Use @upupjs/react if image editing is required. -->`,
})
