...
import { fileGetIsImage, fileGetIsPdf, fileGetIsText, fileCanPreviewText, cn } from '@upup/core/internal'
                                ...
                                >
                                    ...
                                    @if (!textLoading && !textError) {
                                        ...
                                        @if (isTruncated) {
                                            ...
                                            >
                                                Content truncated - file is too
                                                large to preview in full.
                                            </div>
                                        }
                                    }
                                </div>
