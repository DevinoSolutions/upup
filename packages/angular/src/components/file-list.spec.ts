...
function makeFile(id: string, name: string, type = 'image/jpeg', size = 1024): UploadFile {
    return {
        id,
        name,
        type,
...
describe('FilePreviewPortalComponent', () => {
    it('renders the overlay with data-upup-slot="file-preview-portal"', async () => {
        ...
        const el: HTMLElement = fixture.nativeElement
        const portal = el.querySelector('[data-upup-slot="file-preview-portal"]')
...
describe('FileItemComponent', () => {
    it('renders data-testid="upup-file-item"', async () => {
        ...
        const el: HTMLElement = fixture.nativeElement
        expect(el.querySelector('[data-testid="upup-file-item"]')).not.toBeNull()
    })
    ...
    it('does not show preview portal by default', async () => {
        ...
        expect(el.querySelector('[data-upup-slot="file-preview-portal"]')).toBeNull()
    })
    ...
    it('shows preview portal after openPreviewPortal()', async () => {
        ...
        const el: HTMLElement = fixture.nativeElement
        expect(el.querySelector('[data-upup-slot="file-preview-portal"]')).not.toBeNull()
    })
})
...
describe('FileListComponent', () => {
    it('renders data-testid="upup-file-list"', async () => {
        ...
        const el: HTMLElement = fixture.nativeElement
        expect(el.querySelector('[data-testid="upup-file-list"]')).not.toBeNull()
    })
    ...
    it('calls store.handleFileRemove when remove button is clicked', async () => {
        ...
        const el: HTMLElement = fixture.nativeElement
        const removeBtn = el.querySelector('[data-testid="upup-file-remove"]') as HTMLButtonElement | null
        if (removeBtn) {
            removeBtn.click()
            ...
            console.warn('[file-list.spec] upup-file-remove button not found — FileDeleteIcon renders empty')
        }
    })
})
