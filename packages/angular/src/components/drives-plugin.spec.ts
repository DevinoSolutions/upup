...
function makeStore(overrides: Record<string, unknown> = {}): UpupStore {
    ...
    store.setConfig({
        sources: ['local', 'googleDrive', 'oneDrive', 'dropbox', 'box', 'url', 'camera', 'microphone', 'screen'],
        ...overrides,
    } as any)
    store.init()
    return store
...
function makeFakeGoogleDriveService() {
    ...
    class FakeGDService {
        ...
        readonly folder = computed(() => ({ files: [], folders: [] } as unknown as DriveFolder))
...
describe('SourceSelectorComponent', () => {
    ...
    it('renders a tile for each source with the correct data-testid', async () => {
        ...
        // Check key testids
        const url = fixture.nativeElement.querySelector('[data-testid="upup-source-url"]')
        expect(url).not.toBeNull()

        const gd = fixture.nativeElement.querySelector('[data-testid="upup-source-googleDrive"]')
        expect(gd).not.toBeNull()

        const od = fixture.nativeElement.querySelector('[data-testid="upup-source-oneDrive"]')
        expect(od).not.toBeNull()

        const dropbox = fixture.nativeElement.querySelector('[data-testid="upup-source-dropbox"]')
        expect(dropbox).not.toBeNull()

        const box = fixture.nativeElement.querySelector('[data-testid="upup-source-box"]')
        expect(box).not.toBeNull()

        const camera = fixture.nativeElement.querySelector('[data-testid="upup-source-camera"]')
        expect(camera).not.toBeNull()

        const micro = fixture.nativeElement.querySelector('[data-testid="upup-source-microphone"]')
        expect(micro).not.toBeNull()

        const screen = fixture.nativeElement.querySelector('[data-testid="upup-source-screen"]')
    ...
    it('source id is "url" (not "link") — testid is upup-source-url', async () => {
        ...
        expect(fixture.nativeElement.querySelector('[data-testid="upup-source-url"]')).not.toBeNull()
    ...
    it('only renders sources configured in the store', async () => {
        ...
        expect(fixture.nativeElement.querySelector('[data-testid="upup-source-dropbox"]')).toBeNull()
    })
})
...
describe('SourceViewComponent', () => {
    ...
    it('renders nothing when no source is active', async () => {
        ...
        const slot = fixture.nativeElement.querySelector('[data-upup-slot="adapter-view"]')
    ...
    it('renders the url-uploader when activeSource is "url"', async () => {
        ...
        const urlEl = fixture.nativeElement.querySelector('[data-upup-slot="url-uploader"]')
    ...
    it('renders the google-drive wrapper when activeSource is "googleDrive"', async () => {
        ...
        const gdEl = fixture.nativeElement.querySelector('upup-google-drive-uploader')
...
describe('GoogleDriveUploaderComponent — wrapper routing', () => {
    ...
    it('mode="client" renders upup-client-google-drive-uploader', async () => {
        ...
        const clientEl = fixture.nativeElement.querySelector('upup-client-google-drive-uploader')
        expect(clientEl).not.toBeNull()

        const serverEl = fixture.nativeElement.querySelector('upup-server-mode-drive-uploader')
...
describe('OneDriveUploaderComponent — wrapper routing', () => {
    ...
    it('mode="client" renders client one-drive uploader', async () => {
        ...
        const clientEl = fixture.nativeElement.querySelector('upup-client-onedrive-uploader')
        expect(clientEl).not.toBeNull()
    })
...
describe('DropboxUploaderComponent — wrapper routing', () => {
    ...
    it('mode="client" renders client dropbox uploader', async () => {
        ...
        const clientEl = fixture.nativeElement.querySelector('upup-client-dropbox-uploader')
        expect(clientEl).not.toBeNull()
    })
...
describe('BoxUploaderComponent — wrapper routing', () => {
    ...
    it('mode="client" renders client box uploader', async () => {
        ...
        const clientEl = fixture.nativeElement.querySelector('upup-client-box-uploader')
        expect(clientEl).not.toBeNull()
    })
