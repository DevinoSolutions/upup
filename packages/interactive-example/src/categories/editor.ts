    ...
    entries: [
        {
            ...
            description:
                'Lazy-loads react-filerobot-image-editor so users can crop, rotate, and annotate images before upload.',
            primitive: 'bool',
            defaultValue: true,
        },
        {
            ...
            label: 'Display mode',
            description:
                'Inline keeps the editor in the dropzone; Modal opens it as an overlay over your page.',
            primitive: 'enum',
            defaultValue: 'inline',
        ...
        },
        {
            ...
            label: 'Auto-open',
            description:
                'When the editor pops up automatically after picking files.',
            primitive: 'enum',
            defaultValue: 'never',
            options: {
                options: ['never', 'single', 'always'],
                layout: 'segmented',
            },
            visibleWhen: { propId: 'imageEditor.enabled', equals: true },
        },
