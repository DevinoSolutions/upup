...
import { ACCEPT_PRESETS } from '@useupup/core'
    ...
    entries: [
        {
            ...
            description:
                'Allowlist for the OS file picker — only matching files are pickable. Pick a preset name (e.g. "images", "documents") or type a raw MIME pattern (comma-separated). Presets expand to full MIME types internally.',
            primitive: 'combo',
            defaultValue: '',
            options: {
                placeholder: 'images',
        ...
        },
        {
            ...
            label: 'Max files',
            description:
                'Upper bound on number of queued files. Echoes in the dropzone copy.',
            primitive: 'number',
            defaultValue: 10,
        ...
        },
        {
            ...
            label: 'Max file size',
            description:
                'Per-file ceiling. Echoes in the dropzone copy and rejects oversized picks.',
            primitive: 'size-unit',
        ...
        },
        {
            ...
            label: 'Min file size',
            description:
                "Per-file floor. Validation-only — fires onRestrictionFailed on too-small picks but isn't shown in the dropzone copy.",
            primitive: 'size-unit',
            defaultValue: undefined,
        ...
        },
        {
            ...
            description:
                'Combined ceiling across the queue. Validation-only — fires onRestrictionFailed when the sum exceeds the limit; not stated upfront.',
            primitive: 'size-unit',
            defaultValue: undefined,
