                ...
                >
                            ...
                            <button
                                ...
                                className={cn(
                                    ...
                                    selected.has(file.id) &&
                                        'upup-bg-[#f0f9ff] dark:upup-bg-[#0c4a6e]/30',
                                    dark
                    ...
                    <div className="upup-flex upup-items-center upup-justify-between upup-gap-2 upup-border-t upup-p-3">
                        ...
                        <button
                            ...
                            className="upup-rounded upup-bg-[#0ea5e9] upup-px-3 upup-py-1.5 upup-text-sm upup-text-white disabled:upup-opacity-50"
                        >
                            {transferring
                                ? 'Uploading…'
