...
export default function AudioUploader() {
    ...
    const { AudioRecordIcon, AudioStopIcon, AudioDeleteIcon } = icons as any
    const tr = TR
                ...
                <div className="upup-flex upup-flex-1 upup-flex-col upup-items-center upup-justify-center upup-gap-4">
                    <button
                        className={cn(
                            ...
                            (classNames as any)?.audioRecordButton,
                        )}
                ...
                <div className="upup-flex upup-flex-1 upup-flex-col upup-items-center upup-justify-center upup-gap-4">
                    <canvas
                        ...
                        className={cn(
                            ...
                            (classNames as any)?.audioWaveform,
                        )}
                    />
                    <span
                        className={cn(
                    ...
                    <button
                        className={cn(
                            ...
                            (classNames as any)?.audioStopButton,
                        )}
                ...
                <div className="upup-flex upup-flex-1 upup-flex-col upup-items-center upup-justify-center upup-gap-4">
                    <div
                        className={cn(
                            ...
                            dark && 'upup-bg-white/5',
                            (classNames as any)?.audioPlaybackContainer,
                        )}
                    >
                        <audio
                    ...
                    <div className="upup-flex upup-gap-3">
                        <button
                            className={cn(
                                ...
                                dark && 'upup-bg-[#59D1F9]',
                                (classNames as any)?.audioAddButton,
                            )}
                        ...
                        <button
                            className={cn(
                                ...
                                (classNames as any)?.audioDeleteButton,
                            )}
