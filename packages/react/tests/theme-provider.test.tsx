...
describe('UpupThemeProvider', () => {
    ...
    it('injects CSS variables on the wrapper element', () => {
        ...
        const wrapper = container.firstChild as HTMLElement
        expect(
            wrapper.style.getPropertyValue('--upup-color-surface'),
        ).toBeTruthy()
        expect(
            wrapper.style.getPropertyValue('--upup-color-primary'),
        ).toBeTruthy()
    })
    ...
    it('applies token overrides', () => {
        ...
        const wrapper = container.firstChild as HTMLElement
        expect(wrapper.style.getPropertyValue('--upup-color-primary')).toBe(
            '#ff0000',
        )
    })
