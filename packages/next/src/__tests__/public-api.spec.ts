...
import * as reactPkg from '@useupup/react'

/**
 * Pins @useupup/next's curated public runtime export lists (F-142).
 * The client entry is a one-line `export * from '@useupup/react'` — its surface
 * is defined to equal react's (see @useupup/preact's equivalent test), not a
...
describe('public API surface (F-142)', () => {
    it('client entry exposes exactly the same runtime export list as @useupup/react', () => {
