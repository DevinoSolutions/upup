...
/**
 * Shared flat ESLint config for the publishable @upupjs/* packages — v2.
...
export default tseslint.config(
    {
        ignores: [
            ...
            // (first hit: @upupjs/vue, PR #320 round of 2026-07-07, when fresh
                    ...
                    paths: [
                        {
                            name: 'libheif-js',
                            message:
                                'Heavy dep — dynamic import() behind @upupjs/core/steps/heic only (principle 6).',
                        },
                        {
                            name: 'tus-js-client',
                            message:
                                'Heavy dep — dynamic import() behind @upupjs/core/strategies/tus-upload only (principle 6).',
                        },
                    ],
                },
            ],
 ...
 * without depending on typescript-eslint directly. Used by @upupjs/preact for its
...
/**
 * Opt-in react-hooks rules for @upupjs/react + @upupjs/preact — NOT in the shared
...
/**
 * @upupjs/core scope layer — core is framework-free and its errors use the
                    ...
                    patterns: [
                        {
                            ...
                            message:
                                '@upupjs/core has ZERO framework dependencies — keep it that way.',
                        },
                        {
                            group: ['@upupjs/core', '@upupjs/core/*'],
                            message:
...
/**
 * @upupjs/server scope layer — errors use the taxonomy; respond.ts is the single
