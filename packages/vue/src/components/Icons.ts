...
export const MyDeviceIcon = defineComponent({
    name: 'MyDeviceIcon',
    setup() {
        return () =>
            h(
...
export const DropBoxIcon = defineComponent({
    name: 'DropBoxIcon',
    setup() {
        return () =>
            h(
...
export const GoogleDriveIcon = defineComponent({
    ...
    setup() {
        return () =>
            h(
                ...
                [
                    h('g', { 'fill-rule': 'nonzero', fill: 'none' }, [
                        h('path', { d: 'M6.663 22.284l.97 1.62c.202.34.492.609.832.804l3.465-5.798H5c0 .378.1.755.302 1.096l1.361 2.278z', fill: '#0066DA' }),
                        h('path', { d: 'M16 12.09l-3.465-5.798c-.34.195-.63.463-.832.804l-6.4 10.718A2.15 2.15 0 005 18.91h6.93L16 12.09z', fill: '#00AC47' }),
                        h('path', { d: 'M23.535 24.708c.34-.195.63-.463.832-.804l.403-.67 1.928-3.228c.201-.34.302-.718.302-1.096h-6.93l1.474 2.802 1.991 2.996z', fill: '#EA4335' }),
                        h('path', { d: 'M16 12.09l3.465-5.798A2.274 2.274 0 0018.331 6h-4.662c-.403 0-.794.11-1.134.292L16 12.09z', fill: '#00832D' }),
                        h('path', { d: 'M20.07 18.91h-8.14l-3.465 5.798c.34.195.73.292 1.134.292h12.802c.403 0 .794-.11 1.134-.292L20.07 18.91z', fill: '#2684FC' }),
                        h('path', { d: 'M23.497 12.455l-3.2-5.359a2.252 2.252 0 00-.832-.804L16 12.09l4.07 6.82h6.917c0-.377-.1-.755-.302-1.096l-3.188-5.359z', fill: '#FFBA00' }),
                    ]),
                ],
            )
    },
...
export const OneDriveIcon = defineComponent({
    name: 'OneDriveIcon',
    setup() {
        return () =>
            h(
                ...
                [
                    h('g', { fill: 'none', 'fill-rule': 'nonzero' }, [
                        h('path', { d: 'M13.39 12.888l4.618 2.747 2.752-1.15a4.478 4.478 0 012.073-.352 6.858 6.858 0 00-5.527-5.04 6.895 6.895 0 00-6.876 2.982l.07-.002a5.5 5.5 0 012.89.815z', fill: '#0364B8' }),
                        h('path', { d: 'M13.39 12.887v.001a5.5 5.5 0 00-2.89-.815l-.07.002a5.502 5.502 0 00-4.822 2.964 5.43 5.43 0 00.38 5.62l4.073-1.702 1.81-.757 4.032-1.685 2.105-.88-4.619-2.748z', fill: '#0078D4' }),
                        h('path', { d: 'M22.833 14.133a4.479 4.479 0 00-2.073.352l-2.752 1.15.798.475 2.616 1.556 1.141.68 3.902 2.321a4.413 4.413 0 00-.022-4.25 4.471 4.471 0 00-3.61-2.284z', fill: '#1490DF' }),
                        h('path', { d: 'M22.563 18.346l-1.141-.68-2.616-1.556-.798-.475-2.105.88L11.87 18.2l-1.81.757-4.073 1.702A5.503 5.503 0 0010.5 23h12.031a4.472 4.472 0 003.934-2.333l-3.902-2.321z', fill: '#28A8EA' }),
                    ]),
                ],
            )
    },
...
export const AudioIcon = defineComponent({
    name: 'AudioIcon',
    setup() {
        return () =>
            h(
...
export const ScreenCastIcon = defineComponent({
    name: 'ScreenCastIcon',
    setup() {
        return () =>
            h(
                ...
                [
                    h('g', { fill: 'currentcolor', 'fill-rule': 'evenodd' }, [
                        h('path', { d: 'M24.182 9H7.818C6.81 9 6 9.742 6 10.667v10c0 .916.81 1.666 1.818 1.666h4.546V24h7.272v-1.667h4.546c1 0 1.809-.75 1.809-1.666l.009-10C26 9.742 25.182 9 24.182 9zM24 21H8V11h16v10z' }),
...
export const UploadIcon = defineComponent({
    name: 'UploadIcon',
    props: { size: { type: Number, default: 24 }, class: { type: String, default: '' } },
    setup(props) {
        return () =>
            h(
                'svg',
                ...
                [
                    ...
                    h('polyline', { points: '7 9 12 4 17 9' }),
                    h('line', { x1: '12', y1: '4', x2: '12', y2: '16' }),
                ],
            )
    },
})
...
/** TbPlayerPlayFilled equivalent */
export const PlayerPlayFilledIcon = defineComponent({
    ...
    setup(props) {
        return () =>
            h(
                ...
                [h('path', { d: 'M6 4l15 8-15 8z' })],
            )
    },
})

/** TbPlayerPauseFilled equivalent */
export const PlayerPauseFilledIcon = defineComponent({
...
/** TbLayoutGrid equivalent */
export const LayoutGridIcon = defineComponent({
    name: 'LayoutGridIcon',
    props: { size: { type: Number, default: 24 } },
    setup(props) {
        return () =>
...
/** TbLayoutList equivalent */
export const LayoutListIcon = defineComponent({
    name: 'LayoutListIcon',
    props: { size: { type: Number, default: 24 } },
    setup(props) {
        return () =>
            h(
                ...
                [
                    h('rect', { x: '4', y: '4', width: '16', height: '6', rx: '1' }),
