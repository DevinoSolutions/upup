...
/**
 * Bridge a headless @upupjs/core store to a Svelte readable store so components
 ...
 * mirroring the @upupjs/vue composables and keeping the server render side-effect-free.
 */
