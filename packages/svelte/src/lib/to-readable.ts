...
/**
 * Bridge a headless @useupup/core store to a Svelte readable store so components
 ...
 * mirroring the @useupup/vue composables and keeping the server render side-effect-free.
 */
