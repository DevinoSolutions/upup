...
export default function MainBoxHeader({ handleCancel }: Props) {
    ...
    return (
        <div className="absolute left-0 right-0 top-0 z-10 grid grid-cols-4 items-center justify-between rounded-t-lg border-b border-[#e0e0e0] bg-[#fafafa] px-3 py-2 max-md:grid-rows-2">
            <button
