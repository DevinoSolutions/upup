import { MetaVersion } from 'components'
import { UpupMini } from 'components/UpupMini'
import { DropZone, Preview } from 'components/UpupUploader'
...
import { BaseConfigs, CloudStorageConfigs } from 'types'

import AdapterSelectorList from 'components/AdapterSelectorList'
import AdapterView from 'components/AdapterView'
import {
    ConfigContextProps,
...
} & Pick<ConfigContextProps, 'adaptersConfigs' | 'loader'>
...
export const UpupUploader: FC<UpupUploaderProps & RefAttributes<any>> =
    forwardRef((props: UpupUploaderProps, ref: ForwardedRef<any>) => {
        ...
        return (
            <ConfigContextProvider
                adaptersConfigs={adaptersConfigs}
                inputRef={inputRef}
                loader={loader}
                accept={accept}
                files={files}
